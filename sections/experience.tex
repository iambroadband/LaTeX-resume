...
%====================
% Kyruus - Entity Data Catalog (EDC)
%====================
% \subsection{{Kyruus \hfill Apr 2022 --- Now}}
% \subtext{Software Engineer / Entity Data Catalog \hfill Fully Remote}
% \begin{zitemize}
% \item set up data aggregator in dev
% \item set up migration tools to get customers off of old platform and into data aggregator
% \end{zitemize}
